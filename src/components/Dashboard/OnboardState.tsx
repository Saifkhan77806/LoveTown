...
const OnboardingState: React.FC<FrozenStateProps> = ({
  freezeEndTime,
  feedback,
}) => {
  const { user } = useUser();
    ...
    <div className="p-6 pt-12">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full mb-4">
          ...
          <span className="text-gray-700 font-medium">Onboarding Period</span>
        </div>
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            Sometimes connections don't align, and that's perfectly okay. This
            pause helps us understand you better and find more compatible
            matches.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3 p-3 bg-warm-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Add new photos or refine your bio
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-warm-50 rounded-lg">
