  ...
  return (
    <div className="p-6 pt-12">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Chatting with</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium text-primary-900">
                {messageCount >= 100
                  ? "Video call unlocked!"
                  : `${100 - messageCount} more messages to unlock video`}
              </h4>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <button
          className="bg-primary-600 text-white p-4 rounded-xl font-medium shadow-lg hover:bg-primary-700 transition-all duration-200 flex items-center justify-center gap-2"
          onClick={() => navigate("/chat")}
        >
          <MessageCircle size={18} />
          Open Chat
        </button>
        <button className="p-4 rounded-xl font-medium shadow-lg transition-all duration-200 flex items-center justify-center gap-2 bg-secondary-600 text-white hover:bg-secondary-700">
          ...
          <div className="flex items-start gap-3 p-3 bg-warm-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Go beyond small talk - explore values, dreams, and experiences
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-warm-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Be vulnerable and genuine - it encourages the same in return
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-warm-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Show genuine interest in their responses and follow up
                thoughtfully
              </p>
            </div>
          </div>
