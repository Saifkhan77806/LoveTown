    ...
    <div className="min-h-screen bg-gradient-to-br from-warm-50 to-primary-50 pb-20">
      <div className="p-6 pt-12">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="p-2 text-gray-600 hover:bg-white hover:shadow-sm rounded-full transition-all duration-200" onClick={() => navigate("/settings")}>
            <Settings size={20} />
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold text-gray-900">{user.name}, {user.age}</h2>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-gray-900">{user.personalityType}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Communication Style</span>
                      <span className="font-medium text-gray-900">{user.communicationStyle}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-20 bg-gray-200 rounded-full h-2">
                          <div 
                            ...
                            style={{ width: `${user.emotionalIntelligence}%` }}
                          ></div>
                        </div>
                        <span className="font-medium text-gray-900">{user.emotionalIntelligence}%</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'compatibility' && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Compatibility Algorithm</h3>
                  <p className="text-gray-600 text-sm">
                    Your matches are based on deep psychological compatibility, shared values, 
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700">Emotional Intelligence</span>
                    <span className="font-medium text-secondary-600">High Match Priority</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700">Core Values Alignment</span>
                    <span className="font-medium text-secondary-600">Essential</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700">Personality Compatibility</span>
                    <span className="font-medium text-primary-600">INFP/ENFP Preferred</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700">Communication Style</span>
                    <span className="font-medium text-accent-600">Empathetic & Direct</span>
                  </div>
                </div>
              </div>
            )}
